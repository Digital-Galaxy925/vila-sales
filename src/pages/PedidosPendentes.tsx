                ...
                <tbody className="divide-y divide-border">
                  {filtered.map((r) => (
                    <tr key={r.codigo} className="h-12 hover:bg-muted/30 transition-colors">
                      <td className="px-3 py-2 font-semibold text-card-foreground whitespace-nowrap bg-muted-foreground/15">
                        {r.bu || "—"}
                      </td>
                      <td className="px-3 py-2 font-mono text-xs text-card-foreground whitespace-nowrap bg-muted-foreground/15">
                        {r.codigo}
                      </td>
                      <td className="px-3 py-2 text-card-foreground align-middle bg-muted-foreground/15">
