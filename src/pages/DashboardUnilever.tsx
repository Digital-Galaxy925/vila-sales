...
const DashboardUnilever = () => {
  ...
  // Vendas já vêm em CAIXAS nos livros.
            ...
            onClick={() => {
              const rows = filteredSorted.map((i) => {
                ...
                return {
                  ...
                  "VD.SEM. -3 (Cx)": Math.round(i.v3),
                  "VD.SEM. -2 (Cx)": Math.round(i.v2),
                  "VD.SEM. -1 (Cx)": Math.round(i.v1),
                  "Venda Média (Cx)": Math.round((i.v1 + i.v2 + i.v3) / 3),
                  "VD.SEM. ATU (Cx)": Math.round(i.vAtu),
                };
              });
