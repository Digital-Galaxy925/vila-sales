  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 12 }}>
        ...
        <KpiCard label="Estoque Total" value={totalEstoque.toLocaleString("pt-BR")} <KpiCard label="Estoque Total" value={totalEstoque.toLocaleString("pt-BR")} sub="caixas" color="#a78bfa" icon="🏭" /> color="#a78bfa" icon="🏭" />
      </div>
