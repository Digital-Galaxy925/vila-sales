      ...
      >
        ...
        <div style={{ padding: "24px 20px 16px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 4 }}>
            ...
            <div>
              <div style={{ fontWeight: 600, fontSize: 14, color: "#1f2937" }}>Vila Sales</div>
              <div style={{ fontSize: 10, color: "#6b7280" }}>Gestão Comercial</div>
            </div>
          </div>
          <div style={{ fontSize: 10, color: "#d1d5db", marginTop: 8, paddingTop: 8, borderTop: "1px solid #e5e7eb" }}>
        ...
        <nav style={{ flex: 1, padding: "0 12px" }}>
          ...
          <button
            ...
            style={{
              ...
              marginBottom: 4,
              background: activeModule === "cruzamento" ? "rgba(0,113,227,0.12)" : "transparent",
              color: activeModule === "cruzamento" ? "#0071e3" : "#6b7280",
          ...
          <button
            ...
            style={{
              width: "100%", display: "flex", alignItems: "center", gap: 10,
              padding: "10px 12px", borderRadius: 10, border: "none", cursor: "pointer",
              marginBottom: 4, background: "transparent", color: "#6b7280",
              fontWeight: 400, fontSize: 13, textAlign: "left" as const, transition: "all .2s",
            }}
          >
            <span style={{ fontSize: 16 }}>📚</span>
          ...
          {modules.filter(m => m.id !== "cruzamento").map((m) => (
            <button
              ...
              style={{
                ...
                padding: "10px 12px", borderRadius: 10, border: "none", cursor: "pointer",
                marginBottom: 4,
                background: activeModule === m.id ? "rgba(0,113,227,0.12)" : "transparent",
                color: activeModule === m.id ? "#0071e3" : "#6b7280",
        ...
        <div style={{ padding: 12 }}>
          ...
          >
            ...
            {(csvLoaded + (baseFile ? 1 : 0)) > 0 && (
              <span style={{ marginLeft: "auto", background: "rgba(0,113,227,0.12)", color: "#0071e3", padding: "1px 8px", borderRadius: 99, fontSize: 11 }}>
